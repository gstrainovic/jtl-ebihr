...
public partial class VStandardKunde
{
    ...
    public string? CKundeAnrede { get; set; }
    ...
    public string? CKundeAdresszusatz { get; set; }
    ...
    public string? CKundeMobil { get; set; }

    public string? CKundeFax { get; set; }

    public int NKundeDebitorennummer { get; set; }

    public string? CKundeMail { get; set; }

    public string? CKundeZusatz { get; set; }

    public string? CKundePostId { get; set; }

    public string? CKundeBundesland { get; set; }

    public string? CKundeIso { get; set; }
