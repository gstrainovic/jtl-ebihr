...
public partial class PfAmazonVc
{
    ...
    public DateTime DUpdatedAtUtc { get; set; }

    public DateTime? DStatusUpdatedAtUtc { get; set; }

    public DateTime? DProcessedAtUtc { get; set; }
