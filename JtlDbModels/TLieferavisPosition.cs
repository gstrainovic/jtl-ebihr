...
public partial class TLieferavisPosition
{
    ...
    public virtual ICollection<TLieferavisSeriennummer> TLieferavisSeriennummers { get; set; } = new List<TLieferavisSeriennummer>();
}
